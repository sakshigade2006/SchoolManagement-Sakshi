                           ...
                           <div class="row col-md-12">
                              <div id="ContentPlaceHolder1_UpPopup">
                                 <input type="submit" name="ctl00$ContentPlaceHolder1$btnView"
                                    value="View Installment" onclick="this.disabled = true"  id="ContentPlaceHolder1_btnView"
                              ...
                              <input type="submit" name="ctl00$ContentPlaceHolder1$btnPrint"
                                 onclick="this.disabled = true" value="Print" id="ContentPlaceHolder1_btnPrint"
